...
În acest fragment se afișează valorile curente obținute de la senzori, cum ar fi acyratețea GPS-ului, locația GPS curentă, numărul de pași numărați, lungimea ultimului pas, valoare unghiului cu care suntem orientați relativ la nord, valori pentru accelerație și giroscop.

Toate aceste informații sunt afișate într-o listă, așa cum poate fi observat în captura de ecran a acestui fragment din Figura \ref{fig:fragment_status}.
